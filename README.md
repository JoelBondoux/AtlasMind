...
<p align="center"><sub> · <strong>Current source version: 0.458.0</strong> · </sub></p>
...
| **Registers that don't forget** | Approvals, defects, tech debt, risk, compliance and research findings *transition* rather than vanish — resolved stays distinct from obsolete, accepted from dismissed — each graded by a published rule table so two people reading the same project get the same answer in March and in July. |
