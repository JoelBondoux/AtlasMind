...
| **TestingScaffolder** | `src/core/testingScaffolder.ts` | Constructs a stack-aware starter testing framework (config + example tests + strategy playbook) from enabled methodologies; non-destructive |
