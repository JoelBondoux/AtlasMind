...
| `AtlasMind: Open UI Studio` | Pick up the UI files found in the project or draw new surfaces, design them beside the canvas with a built-in-browser preview, brand them from named presets, and hand off to the implementation; website profiles also include delivery tooling |
