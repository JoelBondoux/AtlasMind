...
| `More Target Actions…` | Lens file or symbol context menu | Offers Explain, Show impact, and Find tests as focused editable drafts over the same validated target. It never auto-submits |
