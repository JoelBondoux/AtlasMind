...
- Project subtask failures now remain visibly failed when a provider dies before execution starts, instead of being summarized as completed work with an embedded error string.
