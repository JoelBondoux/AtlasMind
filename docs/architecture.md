...
- **`uiDesignGraph.ts`** — sanitizes the target-independent v9 graph against the page inventory, preserves
...
`WebsiteWorkspaceConfig` v9 keeps the compatibility page model and adds the authoritative design core:
