...
All pure or injected + unit-tested. Not yet wired into the scheduler — the policy, the plumbing and the merge land first so each can be reviewed before anything acts on them.
