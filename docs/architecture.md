...
Both pure or injected + unit-tested. Not yet wired into the scheduler — the policy and the plumbing land first so the decision can be reviewed before anything acts on it.
