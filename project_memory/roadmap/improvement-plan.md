...
- [ ] Timeline: N/A
- [ ] Tech stack: Unspecified
- [ ] The Roadmap Dashboard needs attention. It is duplicating items, listing inappropriate items, and the drag to re-order needs clarity in the UX. Also the Mark MVP should have a tooltip for what it actually means for novice developers. #mvp
- [ ] Project: AtlasMind
- [ ] Project type: VS Code App
- [ ] Critical, security, reliability, or production-blocking work.
- [ ] Target audience: Small teams and solo developers
...
- [ ] Timeline: N/A
- [ ] Review the MCP auto config process as it doesn't seem to connect as an error message prompting not all required fields are filled - but that is not apparent from the fields shown. #mvp
- [ ] Tech stack: Unspecified
- [ ] Add document (.md) management dashboard tab. This allows the user to define a document filing system, and which files should be kept updated automatically. #mvp
