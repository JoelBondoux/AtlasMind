      ...
      '<article class="panel-card"' + tooltipAttrs('This is the reflection and next-step area. Review what Atlas concluded, adopt the next prompts or next cards, then decide whether the board is ready for another loop or for execution.') + '>' +
        '<div class="row-head">' +
          ...
          '<div class="ideation-chip-row">' +
            ...
            '<button type="button" class="action-link" data-action="command" data-payload="atlasmind.openWebsiteStudio"' + tooltipAttrs('Open Interface Studio to plan surfaces, compose visual structure, manage a shared visual language, and keep delivery settings nearby.') + '>Interface Studio</button>' +
          '</div>' +
        '</div>' +
