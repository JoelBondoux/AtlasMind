...
export const METHODOLOGY_STANDARDS: Readonly<Record<TestingMethodologyId, StandardTracking>> = {
  ...
  'security-testing': { kind: 'tracked', name: 'OWASP Application Security Verification Standard', edition: '5.0.0', verifiedAt: '2026-09-04', publishedUrl: 'https://owasp.org/www-project-application-security-verification-standard/' },
  ...
  'accessibility': { kind: 'tracked', name: 'W3C WCAG (ISO/IEC 40500:2025)', edition: '2.2 (Recommendation of 2024-12-12)', verifiedAt: '2026-09-04', publishedUrl: 'https://www.w3.org/TR/WCAG22/' },
  ...
  'iso-27001': { kind: 'tracked', name: 'ISO/IEC 27001', edition: '2022 + Amd 1:2024', verifiedAt: '2026-09-04', publishedUrl: 'https://www.iso.org/standard/27001' },
  ...
  'pci-dss': { kind: 'tracked', name: 'PCI DSS', edition: '4.0.1', verifiedAt: '2026-09-04', publishedUrl: 'https://www.pcisecuritystandards.org/document_library/?category=pcidss' },
  'nist-800-53': { kind: 'tracked', name: 'NIST SP 800-53', edition: 'Rev. 5, Release 5.2.0', verifiedAt: '2026-09-04', publishedUrl: 'https://csrc.nist.gov/pubs/sp/800/53/r5/upd1/final' },
  ...
  'sbom': { kind: 'tracked', name: 'CycloneDX (ECMA-424)', edition: '1.7', verifiedAt: '2026-09-04', publishedUrl: 'https://cyclonedx.org/specification/overview/' },
  'dependency-licensing': { kind: 'tracked', name: 'SPDX License List', edition: '3.28.0', verifiedAt: '2026-09-04', publishedUrl: 'https://spdx.org/licenses/' },
  'license-compatibility': { kind: 'tracked', name: 'SPDX License List', edition: '3.28.0', verifiedAt: '2026-09-04', publishedUrl: 'https://spdx.org/licenses/' },
  'secure-build-pipeline': { kind: 'tracked', name: 'SLSA', edition: 'v1.2', verifiedAt: '2026-09-04', publishedUrl: 'https://slsa.dev/spec/v1.2/' },
  'ai-safety-compliance': { kind: 'tracked', name: 'EU AI Act, Regulation (EU) 2024/1689', edition: 'consolidated 2026-07-27, as amended by Regulation (EU) 2026/1744', verifiedAt: '2026-09-04', publishedUrl: 'https://eur-lex.europa.eu/eli/reg/2024/1689/2026-07-27/eng' },
  ...
  'medical-compliance': { kind: 'tracked', name: 'IEC 62304', edition: '2006 + AMD1:2015', verifiedAt: '2026-09-04', publishedUrl: 'https://webstore.iec.ch/en/publication/22794' },
  ...
  'aviation-compliance': { kind: 'tracked', name: 'RTCA DO-178C', edition: '2011', verifiedAt: '2026-09-04', publishedUrl: 'https://www.rtca.org/do-178/' },
  'energy-compliance': { kind: 'tracked', name: 'NERC CIP Reliability Standards', edition: 'CIP-002 through CIP-015, each at its own approved version', verifiedAt: '2026-09-04', publishedUrl: 'https://www.nerc.com/standards/reliability-standards/cip' },
};
