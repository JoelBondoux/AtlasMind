...
export const CAPABILITY_PAGES: readonly CapabilityPage[] = [
  ...
  { surface: 'dashboard', id: 'editions', title: 'Dashboard — Editions', answers: 'planned public tiers, add-ons, feature entitlements, pricing, dates, parameters, files, roadmap links and decision coverage' },
  { surface: 'dashboard', id: 'versions', title: 'Dashboard — Versions', answers: 'public stable and preview releases, their value tier, roadmap gate progress, filed plans and observed next move' },
