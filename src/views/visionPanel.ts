      ...
      bodyContent: `
        <div class="panel-hero">
          ...
          <div class="hero-badges" aria-label="Vision capabilities">
            <button type="button" class="hero-badge hero-badge-button" data-hero-page-target="attachments" title="Open the image attachment page.">Workspace images</button>
            <button type="button" class="hero-badge hero-badge-button" data-hero-page-target="prompt" title="Open the prompt composer page.">Vision prompts</button>
            <button type="button" class="hero-badge hero-badge-button" data-hero-page-target="response" title="Open the streamed response page.">Streaming output</button>
          </div>
        </div>
